...
col_confidence = 'Если все тесты прошли, насколько вы были уверены в том, что проект не содержит критических/блокирующих ошибок'
...
crosstab = pd.crosstab(df['style_group'], df[col_confidence])
