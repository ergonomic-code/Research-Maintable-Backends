...
# Колонки для анализа
col_modules_cycles = 'Были ли циклы в зависимостях между классами, пакетами, модулями, сервисами'
col_model_cycles = 'Встречались ли циклы (двунаправленные связи) в модели'
...
chi_summary(col_modules_cycles)
chi_summary(col_model_cycles)