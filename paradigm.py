...
# Колонки для анализа (вопрос с одним вариантом)
col_paradigm = 'Какая была основная парадигма программирования'
col_support = 'На момент начала вашей работы, описываемый далее проект был на ваш взгляд поддерживаемым'

# Таблица сопряженности
crosstab = pd.crosstab(df[col_paradigm], df[col_support])
